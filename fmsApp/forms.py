...
class HiddenFilePasswordForm(forms.ModelForm):
...
class HiddenFileUploadForm(forms.ModelForm):
    password = forms.CharField(widget=PasswordInput())  # Ensure password uses PasswordInput
